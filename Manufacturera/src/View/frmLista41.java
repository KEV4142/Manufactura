...
public class frmLista41 extends javax.swing.JInternalFrame {
    ...
    public frmLista41() {
        ...
        txtListaID.setText(String.valueOf(auto));
        txtNombre.grabFocus();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimiento de la Tabla Lista.");
        setFrameIcon(null);
        setName("frmLista41"); // NOI18N
        try {
            setSelected(true);
        ...
        jLabel2.setText("Codigo de la Lista :");
        ...
        txtListaID.setEnabled(false);
        txtListaID.setName("Codigo"); // NOI18N
        txtListaID.setOpaque(false);
        getContentPane().add(txtListaID, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 130, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int x=-1;
        try {
            x = Integer.parseInt(JOptionPane.showInputDialog(rootPane, "Ingrese Codigo de la Lista : ", "Ingrese", JOptionPane.INFORMATION_MESSAGE));
            lista=new Lista();
            lista=control.getLista(x);
            if(lista!=null){
                txtListaID.setText(lista.getListaid()+"");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(a){
            lista=new Lista(inter.String_Int(txtListaID.getText()), txtNombre.getText().toUpperCase());
            if(ins){
                control.insLista(lista);
            }
            else{
                control.updLista(lista);
            }
            Limpiar_Campos();
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(!ins){
            ...
            if (res == JOptionPane.YES_OPTION) {
                control.delLista(inter.String_Int(txtListaID.getText()));
                Limpiar_Campos();
            }
        }
