 ...
 * @author root4142
 */
public class frmConModelo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numero de Modelo: ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            if (jTextField1.getText().isEmpty()) {
                ...
                tabla.setModel(controlmodeloDet.getModeloTabla(Integer.parseInt(jTextField1.getText())));
            }
        } catch (Exception e) {
