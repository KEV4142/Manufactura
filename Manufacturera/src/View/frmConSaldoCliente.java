 ...
 * @author root4142
 */
public class frmConSaldoCliente extends javax.swing.JInternalFrame {
    private ControlCliente controlcliente=new ControlCliente();
    
    public frmConSaldoCliente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Formulario de Consulta de Saldos por Cliente.");
        setToolTipText("");
        setFrameIcon(null);
        setName("frmConSaldoCliente"); // NOI18N
        try {
            setSelected(true);
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 110, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 100, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            if (jTextField1.getText().isEmpty()) {
                ...
                tabla.setModel(controlcliente.getModeloTabla(Integer.parseInt(jTextField1.getText())));
            }
        } catch (Exception e) {
